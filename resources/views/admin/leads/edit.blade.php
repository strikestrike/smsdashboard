        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.leads.update", [$lead->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('tag_id') ? 'is-invalid' : '' }}" type="text" name="tag_id" id="tag_id" value="{{ old('tag_id', $lead->tag_id) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('used_campaigns_ids') ? 'is-invalid' : '' }}" type="text" name="used_campaigns_ids" id="used_campaigns_ids" value="{{ old('used_campaigns_ids', $lead->used_campaigns_ids) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('exclude_campaigns_ids') ? 'is-invalid' : '' }}" type="text" name="exclude_campaigns_ids" id="exclude_campaigns_ids" value="{{ old('used_campaigns_ids', $lead->used_campaigns_ids) }}">
